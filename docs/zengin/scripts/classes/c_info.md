...
The `C_INFO` class is used to define dialogues in the game[^1].
...
!!! Info  
    If there are multiple important dialogues that satisfy their condition function, they will be played in the order specified by [`nr`](#int-nr).
...
[^1]: Heavily inspired by the amazing documentation site [Gothic library](http://gothic-library.ucoz.org/publ/class_c_info/1-1-0-33).