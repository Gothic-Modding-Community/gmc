...
### Example
This function is used in the Union Menu [API script](../injection.md#api-script).  
...
This example comes from the `zUnionMenu.d` injectable [API script](../injection.md#api-script) that is part of the [zGamePad]() plugin, [GitHub link](https://github.com/Gratt-5r2/zGamePad/blob/6be647685e2eee5da9aef9d141398fc69cf3a626/Utils/zUnionMenu.d#L47-L57).
