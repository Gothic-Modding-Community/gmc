...
!!! warning
    This method is quite faulty and Spacer.NET is a better tool for this operation. Furthermore, updating the world mesh should be generally avoided altogether because it's generally risky.
